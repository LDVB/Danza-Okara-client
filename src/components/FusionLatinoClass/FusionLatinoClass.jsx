    ...
    return (
        <>
         <div className='fusionClass'>
            ...
            <div class="description-fusion">
                <h1 class="description-fusion__title">Clases Fusión Latino</h1>
                <p class="description-fusion__p"> El propósito de la Danza Fusión Oriental es la de unir varias danzas en una sola entidad. La danza combina elementos de poses tradicionales de danza oriental junto con otras disciplinas fusionando con ritmos latinos.</p>
            ...
            <div class="coursemeal-fusion">
                ...
                <div class="coursemeal-fusion__div ">
